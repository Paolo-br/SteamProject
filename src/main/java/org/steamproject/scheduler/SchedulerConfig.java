...
public class SchedulerConfig {
    ...
    private static final long DEFAULT_REVIEW_VOTE_INTERVAL = 8000;       // 8 secondes (votes fréquents)
    ...
    public long getReviewVoteInterval() {
        return getLong("review.vote.interval", DEFAULT_REVIEW_VOTE_INTERVAL);
    }
    ...
    public String toString() {
        return """
                ...
                getPatchInterval(), getDlcInterval(), getReviewInterval(), getReviewVoteInterval(),
